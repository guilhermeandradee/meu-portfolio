    ...
    return(
        <>
            <section className="font-ralewey row d-flex justify-content-center w-100 px-3 px-md-0 mt-3">
                <div onClick={() => openInNewTab('https://cougar-two.vercel.app/')} className="col-md-5 col-12 me-md-3 rounded-lg image-cougar px-5 mb-3 preencher-div" >
                ...
                <div onClick={() => openInNewTab('https://future-bank.vercel.app/')} className="col-md-5 col-12 rounded-lg image-future-bank px-5 mb-3 preencher-div" >
                    <div className="elemento-de-dentro w-100  p-4 bg-cougar">
                ...
                <div onClick={() => openInNewTab('https://live-chat-smoky.vercel.app/')} className="col-md-5 col-12 me-md-3 rounded-lg image-livechat px-5 mb-3 preencher-div" >
                    <div className="elemento-de-dentro w-100  p-4 bg-cougar ">
