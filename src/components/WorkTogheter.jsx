    ...
    return(
        <>
            <section className="row d-flex justify-content-center w-100 px-3 px-md-0 mt-1">
                <div className="col-md-10 col-12 rounded-lg py-4 gradient px-5" style={{backgroundColor: '#F0F0F0'}}>
                    <div className="w-100 mb-5">
                        <h1 className="w-100 text-start fs-2 fs-md-2">Let's Work Togheter?</h1>
                    </div>

                    <p className="mb-5 fs-6">Feel free to get in touch for collaborations or just to say hello.</p>

                    <p className="">gui.andrade1510@gmail.com</p>

                    <nav className="row mt-5">
                        <div onClick={() => openInNewTab('https://www.linkedin.com/in/guilherme-andrade-600842288/')} className="col-md-4 col-12 rounded-xlg d-flex justify-content-center align-items-center m-0 p-lg-2 p-md-1 p-2 mb-md-0 mb-3 text-light text-center cursor-pointer button-contact" style={{backgroundColor: '#1D1D1D'}} >Contact me</div>
